...
const PIXEL_ART_REVISION = "pixel-art-races-3";
const UI_PATCH_REVISION = "race-identity-r3-4-worldlinks-3";
...
const REQUIRED_SHELL = [
  ...
  `./millennium-polish.js?v=${MILLENNIUM_BUILD}-racefix3`,
  ...
  `./css/races.css?v=${MILLENNIUM_BUILD}-racefix3`,
  `./content-v3.js?v=${MILLENNIUM_BUILD}`,
  `./app.js?v=${MILLENNIUM_BUILD}-racefix3`,
