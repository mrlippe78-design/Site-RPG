...
A versão 3.6.4 preserva integralmente a camada de integridade da Sentinela 3.6.3 para uma comunidade pequena, preservando a edição Firebase Spark e sem excluir ficha, inventário, pets ou histórico.
